...
JobStoreMock.prototype.get = function get( id, cb ) {
    cb(null, (id in this._store) ? this._store[id] : null);
};
...
JobStoreMock.prototype.close = function close( ) {
    return null;
}

// read out the stored keys, for unit tests
JobStoreMock.prototype.keys = function( ) {
