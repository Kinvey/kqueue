...
function configureServer( server, queue, config, serverState ) {
    ...
    server.addHandler('insert', function(req, res, next) {
        ...
        // TODO: flush in batches, use CallbackManager to ack many calls
        // cbm.addCallback(next)
        // on flush: cbm.stage, cbm.release(err, ret)

// FIXME: many back-to-back inserts will cause the fflush loop to never return
